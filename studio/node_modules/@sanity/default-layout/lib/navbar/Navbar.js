...
var Navbar = /*#__PURE__*/(0, _react.memo)(function Navbar(props) {
  ...
  var shouldRender = (0, _react.useMemo)(() => ({
    ...
    tools: mediaIndex >= 3
  }), [mediaIndex]); // Diable fullscreen search and re-focus search button
  ...
  }, [onSearchFullscreenOpen, searchFullscreenOpenButtonElement]); // Enable fullscreen search (passthrough)

  var handleSearchFullscreenOpen = (0, _react.useCallback)(() => {
    onSearchFullscreenOpen(true);
  }, [onSearchFullscreenOpen]); // Disable fullscreen search on media query change (if already open)
